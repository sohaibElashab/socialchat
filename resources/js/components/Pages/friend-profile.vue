...
<!-- Mirrored from iqonic.design/themes/socialv/html-dark/friend-profile.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 31 Mar 2021 22:00:43 GMT -->
<head>
      <!-- Required meta tags -->
      <meta charset="utf-8">
                        ...
                        <div class="iq-card">
                           <div class="iq-card-body">
                              <div class="post-item">
                                 <div class="user-post-data p-3">
                                    <div class="d-flex flex-wrap">
                                       <div class="media-support-user-img mr-3">
                                          <img class="rounded-circle img-fluid" src="images/user/05.jpg" alt="">
                                       </div>
                                 ...
                                 <div class="user-post">
                                    <a href="javascript:void();"><img src="images/page-img/59.jpg" alt="post-image" class="img-fluid w-100" /></a>
                                 </div>
                                 <div class="comment-area mt-3">
                                    ...
                                    <ul class="post-comments p-0 m-0">
                                       <li class="mb-2">
                                          <div class="d-flex flex-wrap">
                                             <div class="user-img">
                                                <img src="images/user/09.jpg" alt="userimg" class="avatar-35 rounded-circle img-fluid">
                                             </div>
                                       ...
                                       <li>
                                          <div class="d-flex flex-wrap">
                                             <div class="user-img">
                                                <img src="images/user/08.jpg" alt="userimg" class="avatar-35 rounded-circle img-fluid">
                                             </div>
                                             <div class="comment-data-block ml-3">
                                                <h6>Bill Emia</h6>
                                                <p class="mb-0">Lorem ipsum dolor sit amet</p>
                              ...
                              <div class="post-item">
                                 ...
                                 <div class="user-post">
                                    <div class="row">
                                       <div class="col-lg-8">
                                          <a href="javascript:void();">
                                             <img src="images/page-img/56.jpg" alt="post-image" class="img-fluid w-100">
                                          </a>
                                       </div>
                                       <div class="col-lg-4">
                                          <div class="mb-3">
                                             <a href="javascript:void();">
                                                <img src="images/page-img/57.jpg" alt="post-image" class="img-fluid w-100">
                                             </a>
                                          </div>
                                          <a href="javascript:void();">
                                             <img src="images/page-img/58.jpg" alt="post-image" class="img-fluid w-100">
                                          </a>
                                       </div>
                                    </div>
                                 </div>
