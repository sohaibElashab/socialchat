...
<!-- Mirrored from iqonic.design/themes/socialv/html-dark/friend-request.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 31 Mar 2021 21:58:06 GMT -->
<head>
      <!-- Required meta tags -->
      <meta charset="utf-8">
                     ...
                     <div class="iq-card">
                        ...
                        <div class="iq-card-body">
                           <ul class="request-list m-0 p-0">
                              ...
                              <li class="d-flex align-items-center">
                                 <div class="user-img img-fluid"><img src="images/user/16.jpg" alt="story-img" class="rounded-circle avatar-40"></div>
                                 <div class="media-support-info ml-3">
                                    <h6>Cooke Edoh</h6>
                              ...
                              <li class="d-flex align-items-center">
                                 <div class="user-img img-fluid"><img src="images/user/17.jpg" alt="story-img" class="rounded-circle avatar-40"></div>
                                 <div class="media-support-info ml-3">
                                    <h6>Earl E. Riser</h6>
