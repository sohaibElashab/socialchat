                                        ...
                                        <li class="d-flex align-items-center">
                                            ...
                                            >
                                                <a
                                                    ...
                                                    class="mr-3 iq-notify iq-bg-primary rounded"
                                                    ><i
                                                        class="ri-award-line"
                                                    ></i
                                                ></a>
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        >
                                                            ...
                                                            <a
                                                                ...
                                                                href="#"
                                                                ><i
                                                                    class="ri-delete-bin-6-fill mr-2"
                                                                ></i
                                                                >Delete</a
                                                            >
                                                            <a
                                    ...
                                    <ul class="notification-list m-0 p-0">
                                        <li class="d-flex align-items-center">
                                            ...
                                            >
                                                <a
                                                    href="javascript:void();"
                                                    class="mr-3 iq-notify iq-bg-danger rounded"
                                                    ><i
                                                        class="ri-heart-line"
                                                    ></i
                                                ></a>
                                    ...
                                    <ul class="notification-list m-0 p-0">
                                        <li class="d-flex align-items-center">
                                            ...
                                            >
                                                <a
                                                    href="javascript:void();"
                                                    class="mr-3 iq-notify iq-bg-success rounded"
                                                    ><i
                                    ...
                                    <ul class="notification-list m-0 p-0">
                                        <li class="d-flex align-items-center">
                                            ...
                                            >
                                                <a
                                                    href="javascript:void();"
                                                    class="mr-3 iq-notify iq-bg-warning rounded"
                                                    ><i
                                                        class="ri-reply-line"
                                                    ></i
                                                ></a>
                                    ...
                                    <ul class="notification-list m-0 p-0">
                                        <li class="d-flex align-items-center">
                                            ...
                                            >
                                                <a
                                                    href="javascript:void();"
                                                    class="mr-3 iq-notify iq-bg-info rounded"
                                                    ><i
                                                        class="ri-share-line"
                                                    ></i
                                                ></a>
