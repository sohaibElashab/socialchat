                                ...
                                <div class="iq-card">
                                    ...
                                    <div class="iq-card-body">
                                        <ul class="list-inline p-0 m-0">
                                            ...
                                            >
                                                <i
                                                    class="ri-user-line pr-3 font-size-20"
                                                ></i>
                                                <p class="mb-0">
                                                    Web Developer
                                                </p>
                                            ...
                                            >
                                                <i
                                                    class="ri-git-repository-line pr-3 font-size-20"
                                                ></i>
                                                <p class="mb-0">
                                                    Success in slowing economic
                                                    activity.
                                                </p>
                                            </li>
                                            <li
                                            ...
                                            >
                                                <i
                                                    class="ri-map-pin-line pr-3 font-size-20"
                                                ></i>
                                                <p class="mb-0">USA</p>
                                            </li>
                                            <li
                                            ...
                                            >
                                                <i
                                                    class="ri-heart-line pr-3 font-size-20"
                                                ></i>
                                ...
                                <div class="iq-card">
                                    ...
                                    <div class="iq-card-body">
                                        ...
                                        >
                                            ...
                                            <li
                                                class="col-md-4 col-6 pl-2 pr-0"
                                            >
                                                <a href="javascript:void();"
                                                    ><img
                                ...
                                <div class="iq-card">
                                    ...
                                    <div class="iq-card-body">
                                        ...
                                        >
                                            ...
                                            <li
                                                class="col-md-4 col-6 pl-2 pr-0 pb-0"
                                            >
                                                <a href="javascript:void();"
                                                    ><img
                                                        src="images/user/07.jpg"
                                ...
                                <div id="post-modal-data" class="iq-card">
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            <li
                                                class="iq-bg-primary rounded p-2 pointer"
                                            >
                                                <div
                                                    class="iq-card-header-toolbar d-flex align-items-center"
                                                >
                                        ...
                                        <div class="post-item">
                                            <div class="user-post-data p-3">
                                                <div class="d-flex flex-wrap">
                                                    <div
                                                        class="media-support-user-img mr-3"
                                                    >
                                                        <img
                                                ...
                                                >
                                                    ...
                                                    >
                                                        ...
                                                        <a
                                                            href="javascript:void();"
                                                            ><i
                                                                class="ri-user-smile-line mr-3"
                                                            ></i
                                                        ></a>
                                                        <a
                                                            href="javascript:void();"
                                                            ><i
                                                                class="ri-camera-line mr-3"
                                                            ></i
                                                        ></a>
                                                    </div>
                                                </form>
                                            ...
                                            <div class="user-post-data p-3">
                                                <div class="d-flex flex-wrap">
                                                    ...
                                                    >
                                                        ...
                                                        <p
                                                            class="ml-1 mb-0 d-inline-block"
                                                        >
                                                            Update his Status
                                                        </p>
                                                        <p class="mb-0">
